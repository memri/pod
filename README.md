...
There are no limitations on edge types at the moment.
...
### Submitting your schema as a merge request
If you want to propose a merge request with your schema,
you'll have to make the code changes in "schema" repository:
[https://gitlab.memri.io/memri/schema](https://gitlab.memri.io/memri/schema).

Please refer to that repo-s documentation on how to do that. There, you'll be able to
re-generate the JSON schema. You'll need to copy the resulting file into this project.
