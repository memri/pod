...
* `version` from the input json will be used as item's version if it's >= 1.
  Otherwise, version value of 1 will be used.
...
* `version` maximum of the database version + 1 and this version 
  will be written as the new item's version
...
### POST /v3/$owner_key/search_by_properties/
```json
{
  "databaseKey": "2DD29CA851E7B56E4697B0E1F08507293D761A05CE4D1B628663F411A8086D99",
...
about the Schema [here](./Schema.md).
