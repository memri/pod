...
const ITEMS_INDEX_DDL: &str = "
    CREATE INDEX IF NOT EXISTS idx_items_created_at ON items(dateCreated);
    CREATE INDEX IF NOT EXISTS idx_items_modified_at ON items(dateModified);
    CREATE INDEX IF NOT EXISTS idx_items_read_at ON items(dateAccessed) WHERE dateAccessed IS NOT NULL;
    CREATE INDEX IF NOT EXISTS idx_items_type_modified_at ON items(type, dateModified);
";
...
const RELATION_INDEXES_DDL: &str = "
    ...
    CREATE INDEX IF NOT EXISTS idx_relations_modified_at ON relations(dateModified);
    CREATE INDEX IF NOT EXISTS idx_relations_read_at ON relations(dateAccessed) WHERE dateAccessed IS NOT NULL;
";
